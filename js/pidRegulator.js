...
function drawPIRegulatorWithHigherKp() {
    ...
    let chart = new google.visualization.LineChart(document.getElementById('pi_hkp_regulator'));
...
function drawPIDRegulator() {
    ...
    let chart = new google.visualization.LineChart(document.getElementById('pid_regulator'));
